...
function UnMatchDir() {
    var flag = false;
    var MactchDirs = new Array("jiaocheng/weixin");
    for (var v = 0; v < MactchDirs.length; v++) {
        if (document.URL.toLocaleLowerCase().indexOf("http://www.7y7.com" + MactchDirs[v] + "") > -1) {
            flag = true; break;
        }
    }
    return flag;
...
if (!IsPC()) {
    ...
    if (!UnMatchDir()) {
        url = url.replace("http://www.7y7.com", "http://i.7y7.com");
    } else {
        url = "http://i.7y7.com";
    }
    location.href = url;
...
$(function () {
    ...
    html += '<div class="close"><a href="javascript:;" onclick="close_my_rmd()"><img src="http://pub.7y7.com/images/festival/2014chunjie/x.gif" width="20" height="20"  /></a></div>';
    html += '<div class="top">';
